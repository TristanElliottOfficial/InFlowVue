...
@section('content')
    <v-header title="{{ __('Create New Project') }}" description="{{ __('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, hic.') }}">
    ...
    <div class="px-10">
        <div class="bg-white px-6 py-5 rounded shadow-lg mt-4">
            <form action="{{ route('projects.store') }}" method="post">
                ...
                <div class="form-group">
                    <button class="button button-default">Create New Project</button>
                </div>
            </form>
        </div>
    </div>
